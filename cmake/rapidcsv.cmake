...
macro(rapidcsv_build)
    ...
    # option(RAPIDCSV_DEBUG_LOG  "Set to ON for debugging logs"   "$<AND:$<CONFIG:Debug>,$<RAPIDCSV_STANDALONE_PROJECT>>")
    #]===========]

    #[==================================================================================[
    add_subdirectory(include)  ??? is it needed ; if so then with include/rapidcsv
    ...
    target_link_libraries(rapidcsv INTERFACE
...
function(rapidcsv_install_logic)
    ...
    #]==================================================================================]
    set(targets_export_name rapidcsv-export)
    ...
    configure_package_config_file(
        ${PackagingTemplatesDir}/rapidcsv-config.cmake.in
        ${project_config}
    ...
    # Uninstall
    add_custom_target(uninstall COMMAND "${CMAKE_COMMAND}" -E remove "${CMAKE_INSTALL_PREFIX}/include/rapidcsv")
endfunction()
