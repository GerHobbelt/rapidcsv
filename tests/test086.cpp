...
int main()
{
  ...
  try
  {
    ...
    ExpectExceptionMsg(doc.GetColumn<int>(2), std::out_of_range,
                       "include/rapidcsv/rapidcsv.h:417 Document::GetColumn() # requested column index 2 >= 2 (number of columns on row index 1)");
    ExpectExceptionMsg(doc.GetColumn<int>("C"), std::out_of_range,
                       "include/rapidcsv/rapidcsv.h:417 Document::GetColumn() # requested column index 2 >= 2 (number of columns on row index 1)");
    ExpectExceptionMsg(doc.GetColumn<int>(3), std::out_of_range,
                       "include/rapidcsv/rapidcsv.h:417 Document::GetColumn() # requested column index 3 >= 3 (number of columns on row index 0)");
  }
