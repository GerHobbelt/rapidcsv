...
int main()
{
  ...
  try
  {
    rapidcsv::Document doc("../tests/chi-utf16.csv", rapidcsv::LabelParams(rapidcsv::FlgColumnName::CN_PRESENT, rapidcsv::FlgRowName::RN_PRESENT), rapidcsv::SeparatorParams(';'));
