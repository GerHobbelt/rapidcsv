...
/*
    unittest::ExpectEqual(double, viewdoc.GetViewCell<double>("Open", "2016-12-28"), 63.400002);     // date-column is not used as label
...
*/
    ...
    unittest::ExpectEqual(double, viewdoc1.GetViewCell<double>(1, 0), 25.499999);
    unittest::ExpectEqual(unsigned long, viewdoc1.GetViewCell<unsigned long>(5, 0), 1031788800);
    unittest::ExpectEqual(long double, viewdoc1.GetViewCell<long double>(6, 0), 0.065616L);
...
/*
    unittest::ExpectEqual(double, viewdoc1.GetViewCell<double>("Open", "1986-03-17"), 29.000001);     // date-column is not used as label
...
*/
    ...
    unittest::ExpectEqual(double, viewdoc2.GetViewCell<double>(1, 0), 62.959999);
    unittest::ExpectEqual(unsigned long, viewdoc2.GetViewCell<unsigned long>(5, 0), 25579900);
    unittest::ExpectEqual(long double, viewdoc2.GetViewCell<long double>(6, 0), 61.765546L);
...
/*
    unittest::ExpectEqual(double, viewdoc2.GetViewCell<double>("Open", "2016-12-28"), 63.400002);     // date-column is not used as label
