...
int main()
{
  ...
  try
  {
    ...
    doc.GetCell<char COMMA &rapidcsv::ConvertFromStr<char COMMA rapidcsv::S2T_Format_StreamAsIs>::ToVal>(3, 0);
    doc.GetCell<int, &rapidcsv::ConvertFromStr<int, rapidcsv::S2T_Format_StreamAsIs>::ToVal>(3, 1);
    doc.GetCell<unsigned int COMMA &rapidcsv::ConvertFromStr<unsigned int COMMA rapidcsv::S2T_Format_StreamAsIs>::ToVal>(3, 2);
