...
int main()
{
  ...
  try
  {
    ...
    rapidcsv::Document doc1(fstream, rapidcsv::LabelParams(rapidcsv::FlgColumnName::CN_PRESENT, rapidcsv::FlgRowName::RN_PRESENT));
    fstream.close();
    ...
    rapidcsv::Document doc2(sstream, rapidcsv::LabelParams(rapidcsv::FlgColumnName::CN_PRESENT, rapidcsv::FlgRowName::RN_PRESENT));
