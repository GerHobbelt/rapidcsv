...
int main()
{
  ...
  try
  {
    ...
    // ExpectExceptionMsg(viewdoc.GetViewRow<int COMMA unsigned COMMA long>("2"), std::out_of_range, "include/rapidcsv/rapidcsv.h: Document::GetRowIdx(pRowName) row not found: 2");
