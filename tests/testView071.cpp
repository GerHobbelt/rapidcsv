...
int main()
{
  ...
  try
  {
    ...
    ExpectExceptionMsg(viewdoc2.GetViewRowIdx("2"), std::out_of_range, "row filtered out: 2");
    unittest::ExpectEqual(size_t, viewdoc2.GetViewRowIdx("3"), 2);
    ExpectExceptionMsg(viewdoc2.GetViewRowIdx("6"), std::out_of_range, "row filtered out: 6");
