// testView023.cpp - read cell value, no row/column labels
...
int main()
{
  ...
  try
  {
    ...
    unittest::ExpectEqual(int, viewdoc.GetViewCell<int>(0, 1), 5);
    unittest::ExpectEqual(int, viewdoc.GetViewCell<int>(1, 1), 25);
    unittest::ExpectEqual(int, viewdoc.GetViewCell<int>(2, 1), 625);

    unittest::ExpectEqual(int, viewdoc.GetViewCell<int>(0, 2), 7);
    unittest::ExpectEqual(int, viewdoc.GetViewCell<int>(1, 2), 49);
    unittest::ExpectEqual(int, viewdoc.GetViewCell<int>(2, 2), 2401);
    ...
    unittest::ExpectEqual(int, viewdoc1.GetViewCell<int>(0, 1), -6);
    unittest::ExpectEqual(int, viewdoc1.GetViewCell<int>(1, 1), 36);
    unittest::ExpectEqual(int, viewdoc1.GetViewCell<int>(2, 1), 1296);

    unittest::ExpectEqual(int, viewdoc1.GetViewCell<int>(0, 5), 7);
    unittest::ExpectEqual(int, viewdoc1.GetViewCell<int>(1, 5), 49);
    unittest::ExpectEqual(int, viewdoc1.GetViewCell<int>(2, 5), 2401);
    ...
    unittest::ExpectEqual(int, viewdoc2.GetViewCell<int>(0, 1), 7);
    unittest::ExpectEqual(int, viewdoc2.GetViewCell<int>(1, 1), 49);
    unittest::ExpectEqual(int, viewdoc2.GetViewCell<int>(2, 1), 2401);
