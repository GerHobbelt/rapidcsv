// testView025.cpp - read column values, no row/column labels
...
int main()
{
  ...
  try
  {
    ...
    ints = viewdoc.GetViewColumn<int>(1);
    unittest::ExpectEqual(size_t, ints.size(), 4);
    ...
    ints = viewdoc1.GetViewColumn<int>(1);
    unittest::ExpectEqual(size_t, ints.size(), 7);
    ...
    ints = viewdoc2.GetViewColumn<int>(1);
    unittest::ExpectEqual(size_t, ints.size(), 4);
