...
if [[ "${BUILD}" == "1" ]]; then
  ...
  cmake -DRAPIDCSV_BUILD_TESTS=ON -DCMAKE_BUILD_TYPE=Debug -DCMAKE_CXX_COMPILER=${CXX_COMPILER}  ${LOCAL_DATELIB} ${LOCAL_CONVERTERLIB} .. && \
  ...
  cmake -DRAPIDCSV_BUILD_TESTS=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_COMPILER=${CXX_COMPILER}  ${LOCAL_DATELIB} ${LOCAL_CONVERTERLIB} .. && \
...
if [[ "${MEMCHECK}" == "1" ]]; then
  ...
  cmake -DRAPIDCSV_BUILD_TESTS=ON -DCMAKE_BUILD_TYPE=MemCheck -DCMAKE_CXX_COMPILER=${CXX_COMPILER}  ${LOCAL_DATELIB} ${LOCAL_CONVERTERLIB} .. && \
...
if [[ "${COVERAGE}" == "1" ]]; then
  ...
  cmake -DRAPIDCSV_BUILD_TESTS=ON -DCMAKE_BUILD_TYPE=Coverage -DCMAKE_CXX_COMPILER=${CXX_COMPILER}  ${LOCAL_DATELIB} ${LOCAL_CONVERTERLIB} .. && \
...
if [[ "${CPUPROF}" == "1" ]]; then
  ...
  cmake -DRAPIDCSV_BUILD_TESTS=ON -DCMAKE_BUILD_TYPE=CpuProf -DCMAKE_CXX_COMPILER=${CXX_COMPILER}  ${LOCAL_DATELIB} ${LOCAL_CONVERTERLIB} .. && \
...
if [[ "${MEMPROF}" == "1" ]]; then
  ...
  cmake -DRAPIDCSV_BUILD_TESTS=ON -DCMAKE_BUILD_TYPE=MemProf -DCMAKE_CXX_COMPILER=${CXX_COMPILER}  ${LOCAL_DATELIB} ${LOCAL_CONVERTERLIB} .. && \
...
if [[ "${CPPCHECK}" == "1" ]]; then
  ...
  cmake -DRAPIDCSV_BUILD_TESTS=ON -DCMAKE_BUILD_TYPE=CppCheck -DCMAKE_CXX_COMPILER=${CXX_COMPILER}  ${LOCAL_DATELIB} ${LOCAL_CONVERTERLIB} .. && \
